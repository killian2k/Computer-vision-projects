...
def run_training_epoch(net: torch.nn.Module, optimizer: torch.optim, dataloader: DataLoader):
    loss_aggregator = UpdatingMean()
    # Put the network in training mode.
    net.train()
    # Loop over batches.
    for batch in tqdm(dataloader):
        train,test = batch['input'], batch['annotation']
        ...
        loss = F.cross_entropy(output,test)
...
if __name__ == '__main__':
    ...
    print("number of parameters for the model is: {}".format(pytorch_total_params))
